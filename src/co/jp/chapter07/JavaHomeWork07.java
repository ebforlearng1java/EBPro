/**ーーーーーーーーーーーーーーーーー07 OOP - その１ーーーーーーーーーーーーーーーーー */
...
public class JavaHomeWork07 {
	...
	//		 }
	//	}
	//回答：Match.javaに1－3のメソッドを作成して、このクラスのmainメソッドで呼び出している。
	...
	public static void main(String[] args) {
		int[] array1 = new int[] { 2, 3, 4, 5, 6, 2, 1 };
